 ...
 */
export const linkTo = (app, file) => OC.filePath(app, '', file)
 ...
 * @return {string} the url
 */
export const linkToRemote = service => window.location.protocol + '//' + window.location.host + OC.linkToRemoteBase(service)
...
export const linkToOCS = (service, version) => {
	return window.location.protocol + '//' + window.location.host + OC.getRootPath() + '/ocs/v' + (version !== 2) ? 1 : 2 + '.php/' + service + '/'
}
